...
public class InMemoryAccountRepository : IAccountRepository
{
    ...
    private void SetupAccounts()
    {
        ...
        var account1 = _accountFactory.CreateAccount(accountId1, clientId1, AccountType.GIA, AccountStatus.Open, 123.00m);
        _accounts.Add(account1);
        var accountId2 = AccountId.From(Guid.Parse("98efcbe7-681a-46b6-ae5b-73dc70ef7a80"));
        var account2 = _accountFactory.CreateAccount(accountId2, clientId1, AccountType.SIPP, AccountStatus.Open, 8000.00m);
        ...
        var account3 = _accountFactory.CreateAccount(accountId3, clientId2, AccountType.JISA, AccountStatus.Closed, 3500.00m);
